...
public class CercaVoloAdminGUI {
    ...
    public CercaVoloAdminGUI(JFrame frameChiamante,Controller controller) throws IOException {
        frame = new JFrame("Ricerca Voli Admin");
        frame.setContentPane(cercaVoloPanel);

        cercaVoloPanel.setLayout(new OverlayLayout(cercaVoloPanel));
        contentPanel.setOpaque(false);
        cercaVoloPanel.add(contentPanel);
        ...
        salvaModificheButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                super.mouseEntered(e);
                salvaModificheButton.setBackground(Color.lightGray);
            }

            @Override
            public void mouseExited(MouseEvent e) {
                super.mouseExited(e);
                salvaModificheButton.setBackground(null);
            }
        });
